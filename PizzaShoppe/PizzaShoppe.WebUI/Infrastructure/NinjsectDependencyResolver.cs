...
namespace PizzaShoppe.WebUI.Infrastructure
{
    public class NinjsectDependencyResolver : IDependencyResolver
    {
        ...
        private void AddBindings()
        {
            ...
            //{
            //    new Appetizer {Name = "Crispy Cauliflower", LargePrice = 8 },
            //    new Appetizer{Name= "Onion Rings", LargePrice = 7},
            //    new Appetizer{Name="Garlic Provolone Breadsticks", LargePrice =6}
            //});
